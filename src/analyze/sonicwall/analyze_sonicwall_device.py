...
def analyze_sonicwall_device(device, input_filename, output_filename, output_type, configuration, online):

    print("[1/4] Initializing pynipper-ng (SonicWALL SonicOS)")
    
    # Instantiate pluggable SonicWALL parser
    ...
    issues = process_sonicos_conf(parser)
