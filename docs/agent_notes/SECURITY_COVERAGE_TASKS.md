...
| F5_BIGIP | Explicit management source/redirect/idle settings, tmsh audit, password-enforcement switch, remote-syslog-none, bound ClientSSL allow-non-SSL | [SC-014](#sc-014), [SC-015](#sc-015), [SC-016](#sc-016), [SC-022](#sc-022), conditional-module [SC-024](#sc-024) |
...
**Status:** Bounded PAN-OS and FortiOS explicit critical/high selector actions implemented; signature exceptions, unqualified vendor defaults and required-function policy remain open.
...
**Status:** Ready for explicit bindings/settings after vendor grammar qualification.
...
**Status:** Ready for supported SCF/tmsh syntax qualification.
...
| F5 | [bigip.py](../../src/devices/f5/bigip.py) | [checks](../../src/analyze/f5/plugins/bigip_checks_plugin.py) `analyze`: ten bounded explicit-setting/bound-cleartext checks. `_FIELDS`, profile and virtual records define the small supported evidence set. |
